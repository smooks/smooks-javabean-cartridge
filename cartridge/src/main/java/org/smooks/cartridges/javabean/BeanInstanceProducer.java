...
public class BeanInstanceProducer extends AbstractBeanInstanceProducer implements BeforeVisitor, AfterVisitor, ContentDeliveryConfigLifecycle {
    ...
    public void doPostConstruct() {
        ...
        List<Parameter<?>> initValExpressions = resourceConfig.getParameters(INIT_VAL_EXPRESSION);
    ...
    protected void visitAfter(ExecutionContext executionContext, Fragment<?> source) {
        ...
        if (isBeanTypeArray) {
            ...
            if (LOGGER.isDebugEnabled()) {
                LOGGER.debug("Converting bean [{}] to an array and rebinding to context", beanIdName);
            }
    ...
    public Optional<String> getBeanFactoryDefinition() {
