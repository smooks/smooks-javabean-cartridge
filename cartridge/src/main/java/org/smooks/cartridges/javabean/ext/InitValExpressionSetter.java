...
public class InitValExpressionSetter implements DOMVisitBefore {
    ...
    public void visitBefore(Element element, ExecutionContext executionContext) throws SmooksException {
        ...
        if (initValExpression != null) {
            ...
            ResourceConfig beanInstanceProducerResourceConfig = extensionContext.getResourceConfigsByName(BeanInstanceProducer.class.getName());
            String propertyName = DomUtils.getAttributeValue(element, "property");

            beanInstanceProducerResourceConfig.setParameter(BeanInstanceProducer.INIT_VAL_EXPRESSION, "this." + propertyName + " = (" + initValExpression + ");");
        }
    }
}
