...
@VisitBeforeReport(condition = "parameters.containsKey('wireBeanId') || parameters.containsKey('valueAttributeName')",
        ...
        detailTemplate = "reporting/BeanValueBinderReport_Before.html")
@VisitAfterReport(condition = "!parameters.containsKey('wireBeanId') && !parameters.containsKey('valueAttributeName')",
        ...
        detailTemplate = "reporting/BeanValueBinderReport_After.html")
public class BeanValueBinder implements BeforeVisitor, AfterVisitor, ChildrenVisitor, Producer, Consumer {

    protected static final Logger LOGGER = LoggerFactory.getLogger(BeanValueBinder.class);
    ...
    public void postConstruct() {
        ...
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("Bean Instance Populator created for [{}].  property={}", beanIdName, property.orElse(null));
        }
    }

    protected void buildId() {
        StringBuilder idBuilder = new StringBuilder();
        idBuilder.append(BeanValueBinder.class.getName());
        idBuilder.append("#");
    ...
    protected void bindBeanValue(final ExecutionContext executionContext, Fragment source) {
        ...
        if (bean == null) {
            ...
            if (LOGGER.isDebugEnabled()) {
                LOGGER.debug("Registering bean ADD wiring observer for wiring bean '{}' onto target bean '{}'", wireBeanId, beanId.getName());
            }
