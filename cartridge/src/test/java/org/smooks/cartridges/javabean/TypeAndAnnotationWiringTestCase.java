 ...
 */
public class TypeAndAnnotationWiringTestCase {

    @Test
    public void test_by_type() throws IOException, SAXException {
        test("test_bean_17.xml");
    }

    @Test
    public void test_by_anno() throws IOException, SAXException {
        test("test_bean_18.xml");
    }

    @Test
    public void test_bad_config() throws IOException, SAXException {
        try {
            test("test_bean_19.xml");
    ...
    public void test(String config) throws IOException, SAXException {
        ...
        smooks.filterSource(new StreamSource<>(getClass().getResourceAsStream("order-03.xml")), sink);
