...
* Java 8 starting from JavaBean Cartridge v2.0.0
* Java 11 or higher starting from JavaBean Cartridge v3.0.0
...
Take a look at the https://github.com/smooks/smooks-examples/tree/v6[model-driven-basic
...
See the https://github.com/smooks/smooks-examples/tree/v6/xml-read-write[xml-read-write]
example.
...
See the https://github.com/smooks/smooks-examples/tree/v6/xml-read-write-transform[xml-read-write-transform] example.
